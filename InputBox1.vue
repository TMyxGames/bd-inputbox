...
<style scoped>
    ...
    .clear-icon { 
        ...
        -webkit-mask-image: url("icons/clear-icon.svg");
        mask-image: url("icons/clear-icon.svg");
    ...
    .eye-open { 
        ...
        -webkit-mask-image: url("icons/eye-open-icon.svg");
        mask-image: url("icons/eye-open-icon.svg");
    ...
    .eye-close { 
        ...
        -webkit-mask-image: url("icons/eye-close-icon.svg");
        mask-image: url("icons/eye-close-icon.svg");
    }
